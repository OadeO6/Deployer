...
class projectForm(FlaskForm):
    ...
    projectType = SelectField("Select an option", choices=[("Flask", "Flask"), ("StaticPage", ("Static Page")), ("Django", "Django"), ("Next", "Next"), ("React", "React"), ("Python", "Python"), ("JavaScript", "JavaScript"), ("Node", "Node")])
